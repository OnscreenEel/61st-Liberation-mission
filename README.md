...
onLoadMission = "Persistent campaign mission adapted for the 61st Mechanized Infantry Battalion. 
Reclaim Altis sector by sector under the banner of the 61st.";
loadScreen = "images\61st_logo.paa";
overviewText = "This customized adaptation of KP Liberation is designed specifically for the 61st Mechanized Infantry Battalion, 
focusing on combined arms training, long-term operations, and unit cohesion.";
